  ...
  return (
    ...
    >
      ...
      <Suspense fallback={null}>
        <Rig>
          <Triangle color="blue" scale={0.009} rotation={[0, 0, Math.PI / 3]} />
          <Triangle color="red" scale={0.009} position={[-2, 0, -1]} rotation={[0, 0, Math.PI / 3]} />
          <Triangle color="cyan" scale={0.009} position={[2, 0, -2]} rotation={[0, 0, Math.PI / 3]} />
          <Triangle color="orange" scale={0.009} position={[-2, 0, -4]} rotation={[0, 0, Math.PI / 3]} />
